...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PROFILE = 19,                   /* PROFILE  */
  YYSYMBOL_INCLUDE = 20,                   /* INCLUDE  */
  YYSYMBOL_ERROR = 21,                     /* ERROR  */
  YYSYMBOL_RSA = 22,                       /* RSA  */
  YYSYMBOL_ECDSA = 23,                     /* ECDSA  */
  YYSYMBOL_INSECURE = 24,                  /* INSECURE  */
  ...
  YYSYMBOL_nl = 38,                        /* nl  */
  YYSYMBOL_optcommanl = 39,                /* optcommanl  */
...
{
       0,   120,   120,   121,   122,   123,   124,   125,   126,   129,
     144,   154,   157,   177,   178,   181,   184,   185,   188,   188,
     212,   213,   216,   226,   237,   247,   252,   252,   299,   300,
     301,   304,   305,   308,   309,   333,   353,   373,   388,   403,
     418,   428,   440,   441,   444
};
#endif
...
static const char *const yytname[] =
{
  ...
  "CERT", "FULL", "CHAIN", "KEY", "SIGN", "WITH", "CHALLENGEDIR",
  "PROFILE", "INCLUDE", "ERROR", "RSA", "ECDSA", "INSECURE", "STRING",
  "NUMBER", "'\\n'", "'='", "','", "'{'", "'}'", "$accept", "grammar",
  "include", "string", "varset", "optnl", "nl", "optcommanl", "authority",
  "$@1", "authorityopts_l", "authorityoptsl", "domain", "$@2", "keytype",
  "domainopts_l", "domainoptsl", "altname_l", "altname", YY_NULLPTR
};
...
{
     -28,     4,   -28,   -21,    -8,    -6,    -5,    -7,   -28,     1,
      14,    17,    25,   -28,   -28,   -28,   -28,    -3,   -28,   -28,
     -28,   -28,     0,    21,   -28,    28,    29,    29,   -28,    29,
      30,    24,   -28,    51,    42,    33,   -28,     3,    29,    35,
      48,    44,    38,    39,     7,    29,    40,    41,   -28,   -28,
      43,   -28,    46,    47,    53,    56,    49,    45,    52,   -28,
     -28,   -28,    43,   -28,   -28,    -9,    29,   -28,   -28,   -28,
      57,    54,    -9,    29,   -28,   -28,   -28,   -28,   -28,   -28,
      55,   -28,   -28,    58,   -28,   -28,    50,   -26,   -28,    29,
      59,    58,   -28,   -28
};
...
{
       2,     0,     1,     0,     0,     0,     0,     0,     5,     0,
       0,     0,     0,     8,    18,    26,     9,     0,     3,     4,
       6,     7,     0,     0,    11,    12,    14,    14,    10,    14,
       0,     0,    13,     0,     0,     0,    25,     0,    14,     0,
       0,     0,     0,     0,     0,    14,     0,     0,    24,    19,
       0,    21,     0,     0,     0,     0,     0,     0,     0,    40,
      41,    27,     0,    32,    22,    30,    14,    20,    34,    36,
       0,     0,    30,    14,    39,    31,    28,    29,    23,    15,
       0,    37,    35,     0,    38,    44,     0,    14,    33,    14,
      17,     0,    16,    42
};
...
{
     -28,   -28,   -28,   -28,   -28,   -27,    11,   -28,   -28,   -28,
     -28,    60,   -28,   -28,     6,   -28,    32,    -4,   -28
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     9,    25,    10,    30,    67,    91,    11,    22,
      37,    38,    12,    23,    78,    44,    45,    86,    87
};
...
{
      31,    29,    32,    89,     2,     3,    13,     4,    33,    34,
      35,    51,     5,    76,    77,    39,    40,    14,    63,    15,
      16,    17,    24,    41,     6,    42,    43,    36,    18,     7,
      26,     8,    39,    40,    49,    33,    34,    35,    61,    79,
      41,    19,    42,    43,    20,    52,    83,    53,    54,    55,
      56,    27,    21,    28,    36,    46,    29,    47,    48,    57,
      90,    58,    92,    59,    60,    64,    65,    70,    71,    80,
      66,    68,    69,    75,    72,    73,    62,    74,    82,    81,
      84,    88,     0,    85,     0,     0,     0,    93,     0,     0,
     -43,     0,     0,     0,     0,     0,     0,    50
};

static const yytype_int8 yycheck[] =
{
      27,    27,    29,    29,     0,     1,    27,     3,     5,     6,
       7,    38,     8,    22,    23,     8,     9,    25,    45,    25,
      25,    28,    25,    16,    20,    18,    19,    24,    27,    25,
      30,    27,     8,     9,    31,     5,     6,     7,    31,    66,
      16,    27,    18,    19,    27,    10,    73,    12,    13,    14,
      15,    30,    27,    25,    24,     4,    27,    15,    25,    11,
      87,    17,    89,    25,    25,    25,    25,    14,    12,    12,
      27,    25,    25,    62,    25,    30,    44,    25,    72,    25,
      25,    31,    -1,    25,    -1,    -1,    -1,    91,    -1,    -1,
      31,    -1,    -1,    -1,    -1,    -1,    -1,    37
};
...
{
       0,    33,     0,     1,     3,     8,    20,    25,    27,    34,
      36,    40,    44,    27,    25,    25,    25,    28,    27,    27,
      27,    27,    41,    45,    25,    35,    30,    30,    25,    27,
      37,    37,    37,     5,     6,     7,    24,    42,    43,     8,
       9,    16,    18,    19,    47,    48,     4,    15,    25,    31,
      43,    37,    10,    12,    13,    14,    15,    11,    17,    25,
      25,    31,    48,    37,    25,    25,    27,    38,    25,    25,
      14,    12,    25,    30,    25,    38,    22,    23,    46,    37,
      12,    25,    46,    37,    25,    25,    49,    50,    31,    29,
      37,    39,    37,    49
};
...
#line 1464 "y.tab.c"
  ...
  case 25: /* authorityoptsl: INSECURE  */
#line 247 "parse.y"
                           {
			auth->insecure = 1;
		}
...
#line 1492 "y.tab.c"
  ...
  case 27: /* domain: DOMAIN STRING $@2 '{' optnl domainopts_l '}'  */
#line 266 "parse.y"
                                             {
			char		*s;
			const char	*ip;
...
#line 1534 "y.tab.c"
  ...
  case 29: /* keytype: ECDSA  */
#line 300 "parse.y"
                        { (yyval.v.number) = KT_ECDSA; }
#line 1540 "y.tab.c"
    break;

  case 30: /* keytype: %empty  */
#line 301 "parse.y"
                        { (yyval.v.number) = KT_RSA; }
#line 1546 "y.tab.c"
    break;

  case 34: /* domainoptsl: DOMAIN NAME STRING  */
#line 309 "parse.y"
                                     {
			char		*s;
			const char	*ip;
			...
			if ((ip = ip_valid((yyvsp[0].v.string))) != NULL) {
				domain->idtype = ID_IP;
				if ((s = strdup(ip)) == NULL)
					err(EXIT_FAILURE, "strdup");
			} else {
...
#line 1575 "y.tab.c"
  ...
  case 35: /* domainoptsl: DOMAIN KEY STRING keytype  */
#line 333 "parse.y"
                                            {
			char *s;
			if (domain->key != NULL) {
...
#line 1600 "y.tab.c"
  ...
  case 36: /* domainoptsl: DOMAIN CERT STRING  */
#line 353 "parse.y"
                                     {
			char *s;
			if (domain->cert != NULL) {
...
#line 1625 "y.tab.c"
  ...
  case 37: /* domainoptsl: DOMAIN CHAIN CERT STRING  */
#line 373 "parse.y"
                                           {
			char *s;
...
#line 1645 "y.tab.c"
  ...
  case 38: /* domainoptsl: DOMAIN FULL CHAIN CERT STRING  */
#line 388 "parse.y"
                                                {
			char *s;
...
#line 1665 "y.tab.c"
  ...
  case 39: /* domainoptsl: SIGN WITH STRING  */
#line 403 "parse.y"
                                   {
			char *s;
			if (domain->auth != NULL) {
...
#line 1685 "y.tab.c"
  ...
  case 40: /* domainoptsl: CHALLENGEDIR STRING  */
#line 418 "parse.y"
                                      {
			char *s;
...
#line 1700 "y.tab.c"
  ...
  case 41: /* domainoptsl: PROFILE STRING  */
#line 428 "parse.y"
                                 {
			char *s;
