...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LISTEN = 6,                     /* LISTEN  */
  YYSYMBOL_ON = 7,                         /* ON  */
  YYSYMBOL_PORT = 8,                       /* PORT  */
  YYSYMBOL_INET4 = 9,                      /* INET4  */
  YYSYMBOL_INET6 = 10,                     /* INET6  */
  ...
  YYSYMBOL_varset = 20,                    /* varset  */
  YYSYMBOL_portno = 21,                    /* portno  */
  YYSYMBOL_family_inet = 22,               /* family_inet  */
  YYSYMBOL_opt_listen = 23,                /* opt_listen  */
  YYSYMBOL_listener = 24,                  /* listener  */
...
{
       0,   128,   128,   129,   130,   131,   132,   133,   136,   151,
     169,   180,   189,   190,   193,   201,   211,   212,   217,   217
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ERROR", "ARROW",
  "INCLUDE", "LISTEN", "ON", "PORT", "INET4", "INET6", "LOCAL", "SOCKET",
  "STRING", "NUMBER", "'\\n'", "'='", "$accept", "grammar", "include",
  "varset", "portno", "family_inet", "opt_listen", "listener", "main",
  "$@1", YY_NULLPTR
};
...
{
       2,     0,     1,     0,     0,     0,     0,     3,     0,     0,
       0,     7,     8,     0,     0,     4,     5,     6,    18,     9,
      17,     0,    12,    13,    14,    17,    19,    10,    11,    15,
      16
};
...
{
       2,     3,    21,    22,    23,     4,     5,    11,    27,    28,
      12,    13,    14,     6,    15,     7,    16,    17,    18,    19,
       0,     0,     0,    30
};

static const yytype_int8 yycheck[] =
{
       0,     1,     8,     9,    10,     5,     6,    15,    13,    14,
      13,     7,    16,    13,    15,    15,    15,    15,    13,    13,
      -1,    -1,    -1,    25
};
...
{
       0,    18,     0,     1,     5,     6,    13,    15,    19,    20,
      25,    15,    13,     7,    16,    15,    15,    15,    13,    13,
      26,     8,     9,    10,    22,    23,    24,    13,    14,    21,
      24
};
...
#line 1313 "y.tab.c"
  ...
  case 12: /* family_inet: INET4  */
#line 189 "parse.y"
                        { (yyval.v.number) = AF_INET; }
#line 1319 "y.tab.c"
    break;

  case 13: /* family_inet: INET6  */
#line 190 "parse.y"
                        { (yyval.v.number) = AF_INET6; }
#line 1325 "y.tab.c"
    break;

  case 14: /* opt_listen: family_inet  */
#line 193 "parse.y"
                              {
			...
			listen_opts.family = (yyvsp[0].v.number);
		}
#line 1338 "y.tab.c"
    break;

  case 15: /* opt_listen: PORT portno  */
#line 201 "parse.y"
                              {
			...
			listen_opts.port = htons((yyvsp[0].v.number));
		}
#line 1351 "y.tab.c"
    break;

  case 17: /* listener: %empty  */
#line 212 "parse.y"
                              {
...
#line 217 "parse.y"
			...
			listen_opts.ifx = (yyvsp[0].v.string);
