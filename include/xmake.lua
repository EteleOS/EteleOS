--[[
EteleOS: include/xmake.lua, time write: 2026/07/26
...
Manages:
  ...
  - exported include path: public add_includedirs so any module can add_deps("eteleos-headers") and inherit it
  ...
  - compatibility headers: endian.h, fcntl.h, syslog.h, termios.h,
    stdarg.h, stdint.h, varargs.h -- thin symlinks to sys/<name>.h, exactly like the
...
Source of truth for the mapping below: the CURRENT kernel/ tree, 
not the stale include/Makefile, which still refers to pre-restructure
