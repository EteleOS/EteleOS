...
local function parse_modules_list(filepath)
    if not os.isfile(filepath) then
        print(string.format("os-gen-gui: MODULES file not found at %s", filepath))
        return {}
    end
...
print(string.format("os-gen-gui: %d modules discovered from MODULES", #all_modules))
...
f:close()
print(string.format("os-gen-gui: manifest written to %s", outpath))
