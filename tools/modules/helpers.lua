--[[
PeteleOS: tools/modules/helpers.lua, time write: 2026/07/26
...
SAME FILE, not only across files. A plain `function os_get_triple()
...
inside `on_load(function (target) ... os_get_triple() ... end)`
...
reachable via `import("helpers")` from inside any on_load/on_build/
...
os_check_arch() is descripton-scope calling description-scope,
...
canonical list is OS_SUPPORTED_ARCHS / OS_TARGET_TRIPLES in
