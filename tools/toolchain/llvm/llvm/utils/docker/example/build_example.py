"""
This script replaces tools/toolchain/llvm/llvm/utils/docker/example/Dockerfile and is intended to be run with `python build_example.py` instead of `docker build`.
...
ENV_VARS = {}
RUN_STEPS = ['/tmp/scripts/checkout.sh ${checkout_args}', '/tmp/scripts/build_install_llvm.sh --to /tmp/clang-install ${buildscript_args}']
