PeteleOS is an operating system with the goal of a simple and stable operating system for personal.
...
- include/: shared header files for the kernel, libraries and userland
